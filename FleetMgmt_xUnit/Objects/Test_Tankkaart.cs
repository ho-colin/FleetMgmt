...
namespace FleetMgmt_xUnit.Objects {
    public class Test_Tankkaart {
        ...
        public void Test_Kaartnummer_Leeg_InValid(string kaartnummer) {
            ...
            var ex = Assert.Throws<TankkaartException>(() => new Tankkaart(kaartnummer, toekomst, "6969", null, null, FleetMgmt_Business.Enums.TankkaartBrandstof.Benzine));
        ...
        public void Test_geldigheidsDatum_Verleden_InValid() {
            ...
            var ex = Assert.Throws<TankkaartException>(() => new Tankkaart("10", verleden, "6969", null, null, FleetMgmt_Business.Enums.TankkaartBrandstof.Benzine));
        ...
        public void Test_Pincode_Invalid(string pincode) {
            DateTime toekomst = new DateTime(2025, 10, 13);
            var ex = Assert.Throws<TankkaartException>(() => new Tankkaart("10", toekomst, pincode, null, null, FleetMgmt_Business.Enums.TankkaartBrandstof.Benzine));
        ...
        public void Test_Pincode_Valid() {
            DateTime toekomst = new DateTime(2025, 10, 13);
            string pincode = "1243";
            Tankkaart tankkaart = new Tankkaart("10", toekomst, pincode, null, null, FleetMgmt_Business.Enums.TankkaartBrandstof.Benzine);
        ...
        public void Test_Kaartnummer_Valid() {
            ...
            Tankkaart tankkaart = new Tankkaart(kaartnummer, toekomst, "6969", null, null, FleetMgmt_Business.Enums.TankkaartBrandstof.Benzine);
